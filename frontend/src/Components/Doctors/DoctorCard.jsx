...
function DoctorCard({doctor}) {
    const {name,avgRating,experiences, totalRating,photo,specialization}=doctor
  return (
    <>
    <div className='p-3 lg:p-5'>
        ...
        <h2 className='text-[18p] leading-[30px] lg:text-[26px] lg:leading-9 text-headingColor font-blod mt-3 lg:mt-5'>{name}</h2>
        <div className='mt-2 lg:mt-4 flex items-center justify-between'>
            <span className='bg-[#CCF0F3] text-irisBlueColor py-1 px-2 lg:py-2 lg:px-6 text-[12px] leading-4 rounded lg:text-[16px] lg:leading-6 font-semibold'>{specialization}</span>
