    ...
    <div>
        ...
        <form >
            ...
            <div className="mb-5">
                ...
                {formData.qualifications?.map((item,index)=> <div key={index}>
                    <div>
                        ...
                        <button onClick={e=>deleteQualification(e,index)} className='bg-red-600 p-2 rounded-full text-white text-[15px]  mt-2 mb-[25px]'><AiOutlineDelete/></button>
                    </div>
                </div>)}
            ...
            <div className="mb-5">
                ...
                {formData.experiences?.map((item,index)=> <div key={index}>
                    <div>
                        ...
                        <button onClick={e=>deleteExperience(e,index)} className='bg-red-600 p-2 rounded-full text-white text-[15px]  mt-2 mb-[25px]'><AiOutlineDelete/></button>
                    </div>
                </div>)}
                ...
                {formData.timeSlots?.map((item,index)=> <div key={index}>
                    <div>
                        <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5">
                            ...
                            <button onClick={e=>deleteTimeSlot(e,index)} className='bg-red-600 p-2 rounded-full text-white text-[15px]  mt-6 mb-[25px]'><AiOutlineDelete/></button>
                            </div>
                            </div>                        
                    </div>
                </div>)}
            ...
            <div className="mb-5">
                ...
                <textarea name="about" rows={5} value={formData.about} placeholder='Write about yopu' onChange={handleInputChange} className='form__input'></textarea>
            </div>
