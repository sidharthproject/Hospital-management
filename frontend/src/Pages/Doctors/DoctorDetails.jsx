...
console.log("DoctorDetails",doctors);
  ...
  return (
    <section>
      ...
      {loading && <Loader />}
       ...
       {!loading && !error &&  <div className="grid md:grid-cols-3 gap-[50px]">
          ...
          <div className='flex items-center gap-[6px]'>
            <span className='flex items-center gap-[6px] text-[14px] leading-5 lg:text-[16px] lg:leading-7 font-semiblod text-headingColor'>
            ...
            <span className='text-[14px] leading-5 lg:text-[16px] lg:leading-7 font-[400] text-textColor'>({totalRating})</span>
                ...
                <p className='text__para text-[14px] leading-6 md:text-[15px] max-w-[390px]'>{bio}</p>
            </div>
          </div>
      ...
      <div>
      <Panel doctorId={doctors._id} ticketPrice={ticketPrice} timeSlots={timeSlots}/>
      </div>
        </div>}
      </div> 
    </section>
